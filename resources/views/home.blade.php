		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					{{-- The best way would be to grant different permissions to users and administrators.
					 Granting Roles --}}
					{{-- But for now, I'll do it this way. I have to research how to do it with permissions. --}}
					@if(auth()->user()->name=="admin" && auth()->user()->email=="admin
						@gmail.com")
						<a href="{{ url('/posts/importDataFromApi')}}" class="btn btn-outline-dark">Import posts from API</a>
						@endif
